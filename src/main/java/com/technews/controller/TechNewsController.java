...
public class TechNewsController {
  ...
  public String login(@ModelAttribute User user, Model model, HttpServletRequest request)
    ...
    if ((user.getPassword().equals(null) || user.getPassword().isEmpty()) || (
      ...
      model.addAttribute("notice",
          "Email address and password must be populated in order to login!");
      return "login";
    }
  ...
  public String signup(@ModelAttribute User user, Model model, HttpServletRequest request)
    ...
    if ((user.getUsername().equals(null) || user.getUsername().isEmpty()) || (
        ...
        user.getEmail().equals(null) || user.getPassword().isEmpty())) {
      model.addAttribute("notice",
          "In order to signup username, email address and password must be populated!");
      return "login";
    }
  ...
  @PostMapping("/posts")
  public String addPostDashboardPage(@ModelAttribute Post post, Model model,
  ...
  public String updatePostDashboardPage(@PathVariable int id, @ModelAttribute Post post,
  ...
  public String createCommentCommentsPage(@ModelAttribute Comment comment, Model model,
      HttpServletRequest request) {
